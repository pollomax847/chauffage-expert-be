...
class ChaudiereCollectivePage extends ConsumerStatefulWidget {
  const ChaudiereCollectivePage({super.key});

  @override
  ConsumerState<ChaudiereCollectivePage> createState() =>
      _ChaudiereCollectivePageState();
}

class _ChaudiereCollectivePageState
    extends ConsumerState<ChaudiereCollectivePage> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'Puissance totale nécessaire : ${_resultat!['puissanceTotale']?.toStringAsFixed(1) ?? '0'} kW',
